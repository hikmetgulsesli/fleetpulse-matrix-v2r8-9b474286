...
export function VehicleEditorFleetpulseMatrixV2r8({ actions }: VehicleEditorFleetpulseMatrixV2r8Props) {
  return (
    <>
      ...
      <div className="mb-8">
      <h1 className="font-headline-md text-headline-md font-bold text-primary mb-6">FleetPulse Matrix</h1>
      ...
      <div>
      <div className="font-headline-md text-headline-md text-on-surface">Fleet Manager</div>
